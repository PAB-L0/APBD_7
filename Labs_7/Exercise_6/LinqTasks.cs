...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            return Emps.
                Where(emp => emp.Job.Equals("Backend programmer"));
        }
        ...
        {
            return Emps.
                GroupBy(emp => emp.Job, (job, emps) => new
                {
                    Praca = job,
        ...
        {
            return Emps.
                Any(emp => emp.Job.Equals("Backend programmer"));
        }
        ...
        {
            return Emps.
                Where(emp => emp.Job.Equals("Frontend programmer")).OrderByDescending(emp => emp.HireDate).
                First();
        }
        ...
        public static IEnumerable<object> Task11()
        {
            return Depts.
                ...
                Where(pair => pair.numOfEmployees > 1);
        }
        ...
        {
            return Emps.
                GroupJoin(Emps, boss => boss, emp => emp.Mgr, (boss, emps) => new
                {
                    Boss = boss,
                    NumberOfEmployees = emps.Count()
                }).
                Where(pair => pair.NumberOfEmployees >= 1).
                OrderBy(pair => pair.Boss.Ename).
                ThenByDescending(pair => pair.Boss.Salary).
                Select(pair => pair.Boss);
        }
        ...
        {
            return arr.
                GroupBy(element => element, (element, occurrences) => new
                {
                    Element = element,
                    Even = occurrences.Count() % 2 == 1
                }).
                Where(pair => pair.Even).
        ...
        public static IEnumerable<Dept> Task14()
        {
            return Depts.
                ...
                Where(pair => pair.NumberOfEmployees == 0 | pair.NumberOfEmployees == 5).
                Select(pair => pair.Dept).
